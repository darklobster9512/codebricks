      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div className={`relative scroll-hidden delay-2 ${isVisible ? 'scroll-visible' : ''}`}>
          ...
          <div className="relative rounded-lg overflow-hidden border border-border shadow-sm aspect-[4/5] bg-muted">
            ...
            <div className="absolute bottom-6 left-6 right-6 sm:left-7 sm:right-auto inline-flex flex-col gap-1 px-5 py-4 rounded-xl bg-background/95 backdrop-blur-xl border border-border shadow-lg">
